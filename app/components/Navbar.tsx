...
const Navbar = () => {
    ...
    return (
        <header className={NavStyles.main}>
            ...
            <img src="/assets/images/logo-devlinks-large.svg" alt='dev links'/>

            <nav className={NavStyles.links}>
                <a className={NavStyles.navlink}>{linkIcon}Links</a>

                <a className={NavStyles.navlink}>{profileIcon}Profile Details</a>
            </nav>

            <button className={NavStyles.preview}>Preview</button>
        </header>
    )
}
